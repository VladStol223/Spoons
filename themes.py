...
THEME_APP = {            #background color        done button color
    ...
    "vampire_goth":     ["CRIMSON_RED",          "INDIGO"],
    "sunset_glow":      ["DARK_ORANGE",          "RED_ORANGE"],
    "light_academia":   ["BACKGROUND_IMAGE",     "MUTED_BROWN"],
    "retro":            ["VINTAGE_ORANGE",       "MUSTARD_YELLOW"],
    "minimalist":       ["WHITE",                "LIGHT_GRAY"],
    "cosmic":           ["DEEP_SPACE_PURPLE",    "STARDUST_SILVER"],
    "autumn_harvest":   ["RUST",                 "DEEP_ORANGE"],
    "tropical_oasis":   ["TURQUOISE",            "VIBRANT_CORAL"],
    "pastel_dreams":    ["PALE_PINK",            "PASTEL_LAVENDER"],
    "steampunk":        ["BRASS",                "COPPER"],
    "cyberpunk":        ["NEON_PINK",            "ELECTRIC_BLUE"],
    "rustic_charm":     ["WARM_BROWN",           "OAK_WOOD"]
}
THEME_ADD_TASKS = {#add tasks choose folder color    add tasks chosen folder color
    ...
    "autumn_harvest": ["GOLDEN_YELLOW",     "BROWN"],
    "tropical_oasis": ["SUNSHINE_YELLOW",   "LUSH_GREEN"],
    "pastel_dreams":  ["PALE_MINT",         "BABY_BLUE"],
    "steampunk":      ["RUSTED_METAL",      "STEEL_GREY"],
...
THEME_COMPLETE_TASKS = { #complete tasks hub folder color    complete tasks task color
    ...
    "light_academia": ["WARM_GREY",         "SAGE_GREEN"],
    ...
    "tropical_oasis": ["DEEP_BLUE",         "CORAL_PINK"],
    "pastel_dreams":  ["PASTEL_YELLOW",     "PASTEL_PINK"],
    "steampunk":      ["GOLDEN_COG",        "ANTIQUE_BROWN"],
    "cyberpunk":      ["MIDNIGHT_BLACK",    "CYBER_ORANGE"],
    "rustic_charm":   ["DARK_ASH",          "SUNFLOWER_YELLOW"]
}
...
THEME_REMOVE_TASKS = { #remove tasks hub folder color    remove tasks task color
    ...
    "cyberpunk":      ["ELECTRIC_PURPLE",   "NEON_TURQUOISE"],
...
THEME_HUB_BUTTONS = { #add spoons color    add tasks color    complete tasks color    study color    calendar color    store color    stats color
    ...
    "vampire_goth":   ["INDIGO",        "DARK_SLATE_GRAY","DARK_RED",
                       "DIM_GRAY",      "MAROON",      "CRIMSON_RED",      "MAROON"],
    "sunset_glow":    ["TOMATO",        "ORANGE",       "CORAL",
                       "GOLD",          "DARK_ORANGE", "RED_ORANGE",       "ORANGE"],
    "light_academia": ["SOFT_TAUPE",    "WARM_GREY",    "SAGE_GREEN",
                       "LIGHT_IVORY",   "WARM_GREY",    "SOFT_BEIGE",       "SOFT_TAUPE"],
    "retro":          ["MUSTARD_YELLOW","PEACH",        "MINT_GREEN",
                       "VINTAGE_ORANGE","BROWN",        "TEAL",             "VINTAGE_ORANGE"],
    ...
    "autumn_harvest": ["GOLDEN_YELLOW","CRIMSON",       "BURNISHED_RED",
                       "RUST",         "BROWN",         "RUST",            "BROWN"],
    "tropical_oasis": ["SUNSHINE_YELLOW","DEEP_BLUE",   "CORAL_PINK",
                       "LUSH_GREEN",    "AQUA_BLUE",   "TURQUOISE",       "VIBRANT_CORAL"],
    "pastel_dreams":  ["PASTEL_LAVENDER","PALE_MINT",   "PASTEL_PINK",
                       "PALE_PINK",     "PASTEL_YELLOW","PALE_PINK",       "PASTEL_LAVENDER"],
    "steampunk":      ["STEEL_GREY",     "RUSTED_METAL","ANTIQUE_BROWN",
                       "BRASS",         "BURNISHED_COPPER","STEEL_GREY",    "BRASS"],
    "cyberpunk":      ["LIME_YELLOW",    "MIDNIGHT_BLACK","CYBER_ORANGE",
                       "HACKER_GREEN",  "MIDNIGHT_BLACK","NEON_PINK",       "ELECTRIC_BLUE"],
    "rustic_charm":   ["CREAM_WHITE",    "DEEP_GREEN",   "SUNFLOWER_YELLOW",
                       "WARM_BROWN",    "DARK_ASH",     "WARM_BROWN",      "CREAM_WHITE"]
}
...
THEME_CALENDAR = { #urrent day color    current day header color    previous day color    cprevious day header color    next day color    next day header color   month color
    ...
    "vampire_goth":   ["CRIMSON_RED","INDIGO","DARK_SLATE_GRAY","DIM_GRAY",
                       "MAROON","DARK_RED","CRIMSON_RED"],
    ...
    "light_academia": ["SOFT_BEIGE","MUTED_BROWN","LIGHT_IVORY","SOFT_TAUPE",
                       "SAGE_GREEN","WARM_GREY","SAGE_GREEN"],
    "retro":          ["VINTAGE_ORANGE","MUSTARD_YELLOW","PEACH","MINT_GREEN",
                       "TURQUOISE","BROWN","TANGERINE"],
    "minimalist":     ["WHITE","LIGHT_GRAY","SOFT_BLACK","DARK_GRAY",
                       "LIGHT_GRAY","SOFT_BLACK","DARK_GRAY"],
    "cosmic":         ["DEEP_SPACE_PURPLE","STARDUST_SILVER","GALACTIC_BLUE","NEBULA_PINK",
                       "STARFIRE_YELLOW","COSMIC_RED","NEON_GREEN"],
    "autumn_harvest": ["RUST","DEEP_ORANGE","GOLDEN_YELLOW","BROWN",
                       "BURNISHED_RED","CRIMSON","TERRACOTTA"],
    "tropical_oasis": ["TURQUOISE","VIBRANT_CORAL","SUNSHINE_YELLOW","LUSH_GREEN",
                       "CORAL_PINK","DEEP_BLUE","SEAFOAM_GREEN"],
    "pastel_dreams":  ["PALE_PINK","PASTEL_LAVENDER","PALE_MINT","BABY_BLUE",
                       "PASTEL_PINK","PASTEL_YELLOW","MINT_GREEN"],
    "steampunk":      ["BRASS","COPPER","RUSTED_METAL","STEEL_GREY",
                       "GOLDEN_COG","ANTIQUE_BROWN","VINTAGE_GOLD"],
    "cyberpunk":      ["NEON_PINK","ELECTRIC_BLUE","HACKER_GREEN","LIME_YELLOW",
                       "CYBER_ORANGE","ELECTRIC_PURPLE","NEON_TURQUOISE"],
    "rustic_charm":   ["WARM_BROWN","OAK_WOOD","DEEP_GREEN","CREAM_WHITE",
...
THEME_FOLDERS = { #homework fol color    chores fol color    work fol color    misc fol color
    ...
    "retro":          ["VINTAGE_ORANGE","MUSTARD_YELLOW","TURQUOISE","TANGERINE"],
    "minimalist":     ["WHITE","LIGHT_GRAY","SOFT_BLACK","DARK_GRAY"],
    "cosmic":         ["DEEP_SPACE_PURPLE","STARDUST_SILVER","NEBULA_PINK","COSMIC_RED"],
    "autumn_harvest": ["RUST","DEEP_ORANGE","BROWN","TERRACOTTA"],
    "tropical_oasis": ["TURQUOISE","VIBRANT_CORAL","LUSH_GREEN","SEAFOAM_GREEN"],
    "pastel_dreams":  ["PALE_PINK","PASTEL_LAVENDER","BABY_BLUE","MINT_GREEN"],
    "steampunk":      ["BRASS","COPPER","STEEL_GREY","ANTIQUE_BROWN"],
    "cyberpunk":      ["NEON_PINK","ELECTRIC_BLUE","LIME_YELLOW","CYBER_ORANGE"],
    "rustic_charm":   ["WARM_BROWN","OAK_WOOD","DEEP_GREEN","TERRACOTTA"]
}
